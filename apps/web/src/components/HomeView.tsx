...
const AUTHORING_DEFAULT_SCENARIO_INPUTS = {
  artifactKind: 'Design Studio plugin',
  audience: 'Design Studio plugin authors',
  topic: 'packaging a reusable workflow as a Design Studio plugin',
};
...
export function HomeView({
  ...
  async function handlePickWorkingDir() {
    ...
    if (isOpenDesignHostAvailable()) {
      ...
      setError(
        `Couldn't open the folder picker (${'reason' in result ? result.reason : 'host unavailable'}). Please update Design Studio and try again.`,
      );
      return null;
    }
