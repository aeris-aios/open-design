    ...
    <div className={`mcp-oauth-control${connected ? ' connected' : ''}`}>
        ...
        {connected ? (
          ...
          <>
            ...
            <span>
              ...
              <span className="hint">
                Design Studio is listening for the callback in the background.
          ...
          <>
            ...
            <span>
              ...
              <span className="hint">
                ...
                Grok image, video, and TTS in Design Studio — no API key
                needed.
              </span>
            </span>
          </>
      ...
      {isAwaiting ? (
        <div className="xai-oauth-warning" role="status">
          ...
          <em>"Cannot connect to your application"</em>.{' '}
          <strong>That is a UX bug on xAI's side</strong> — the
          authorization is still being delivered to Design Studio in the
