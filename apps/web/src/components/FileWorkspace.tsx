...
const COMMUNITY_PAGE_PRESETS: ProjectPagePreset[] = [
  {
    ...
    category: 'prototype',
    title: pageText('Design Studio Landing', 'Design Studio 落地页', 'Design Studio 落地頁'),
  ...
  <div class="deck-shell">
    <main class="deck-stage" id="deck-stage">
      <section class="slide active cover" data-screen-label="01 Cover">
        <div class="kicker">Design Studio deck</div>
        <h1>${safeTitle}</h1>
...
<body>
  <article>
    <div class="meta">Design Studio document</div>
    <h1>${safeTitle}</h1>
    <p>${safeBody}</p>
    <h2>Purpose</h2>
