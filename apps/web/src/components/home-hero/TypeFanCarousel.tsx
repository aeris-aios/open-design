            ...
            >
              ...
              >
                {panel != null ? (
                  ...
                  /* No example preview for this type (e.g. 网站复刻 ships none)
                     — show its own glyph rather than a bare colour block. */
                  <span className="home-hero__type-fan-card-art-glyph">
                    <Icon name={chip.icon} size={40} />
                  </span>
                )}
              </span>
              </span>
