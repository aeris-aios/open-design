...
export interface Dict {
  ...
  'manualEdit.textAlignJustify': string;
  'manualEdit.textStyle': string;
  'manualEdit.basic': string;
  'manualEdit.stroke': string;
  'manualEdit.spacing': string;
  'manualEdit.effects': string;
  'manualEdit.custom': string;
  'manualEdit.mixed': string;
  'manualEdit.horizontal': string;
  'manualEdit.vertical': string;
  'manualEdit.shadow': string;
  'manualEdit.shadowNone': string;
  'manualEdit.shadowSoft': string;
  'manualEdit.shadowMedium': string;
