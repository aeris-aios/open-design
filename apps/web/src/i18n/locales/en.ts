...
export const en: Dict = {
  ...
  'chat.runError.title.agentCrashed': 'Agent exited unexpectedly',
  "chat.runError.agentCrashedMessage": "{agent} exited unexpectedly and didn't say why. Retrying usually recovers; if it keeps happening, send us the logs.",
  'chat.runError.title.accountSuspended': 'Account temporarily suspended',
  "chat.runError.accountSuspendedMessage": "We detected unusual payment risk on this account. If you think this is a mistake, contact us and we'll look into it.",
  "chat.runError.fallbackMessage": "This one didn't get through. The original error is under “View details” below; if it keeps happening, send us the logs.",
  ...
  'chat.queuedChipFilesMany': '{n} files',
  'chat.queuedChipMarksOne': '{n} mark',
  'chat.queuedChipMarksMany': '{n} marks',
  'chat.queuedChipPluginsOne': '{n} plugin',
  'chat.queuedChipPluginsMany': '{n} plugins',
  'chat.queuedChipSkillsOne': '{n} skill',
  'chat.queuedChipSkillsMany': '{n} skills',
  'chat.queuedChipMcpOne': '{n} MCP server',
  'chat.queuedChipMcpMany': '{n} MCP servers',
  'chat.queuedChipConnectorsOne': '{n} connector',
  'chat.queuedChipConnectorsMany': '{n} connectors',
  'chat.queuedChipContextOne': '{n} context item',
  'chat.queuedChipContextMany': '{n} context items',
  'chat.send': 'Send',
  'chat.stop': 'Stop',
  ...
  'chat.amrBalanceOwner.title': "Your workspace is out of credits",
  'chat.amrBalanceOwner.message': "Credits and the plan for this workspace are managed by its owner. Send them the note below — the task continues on its own once the top-up lands.",
  'chat.amrBalanceOwner.requestTemplate': "Our Open Design workspace has run out of credits, so tasks can't start. Could you top up or upgrade the plan in the Open Design console?",
  'chat.amrBalanceOwner.copyCta': "Copy request",
  'chat.amrBalanceOwner.copiedCta': "Copied",
  ...
  "chat.edge.reconnectFailed": "Connection failed",
  "chat.edge.reconnecting": "Reconnecting",
