...
export const en: Dict = {
  ...
  'invite.landing.subtitle': "You’ve been invited to collaborate in Design Studio.",
  ...
  'invite.success.body': "Opening Design Studio so you can start collaborating.",
  'invite.success.roleReceipt': "Joined as",
  'invite.success.enter': "Enter workspace",
  'invite.open.cta': "Open Design Studio",
  'invite.open.opening': "Opening Design Studio…",
  'invite.open.retry': "Already installed? Try opening again",
  'invite.notInstalled.title': "Didn’t open automatically?",
  'invite.notInstalled.body': "You may not have Design Studio installed yet. Install it, then reopen this link to finish joining.",
  'invite.notInstalled.download': "Download Design Studio",
  ...
  'chat.amrCard.switchBody': 'Switch to AERIS Cloud — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrCard.switchCta': 'Switch to AERIS Cloud & retry',
  'chat.amrError.authMessage': 'Your AERIS Cloud account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your AERIS Cloud allowance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with AERIS Cloud',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the AERIS Cloud agent — sign in and this task can start right away.',
  ...
  'chat.runError.signInMessage.amr': 'The AERIS Cloud agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the AERIS Cloud agent — steadier and better value.',
  ...
  'chat.runError.cpuUnsupportedMessage': "This agent's runtime needs a CPU instruction set (AVX2) that this device doesn't have, so it can't start. Update Design Studio to the latest version, which ships a compatible runtime.",
  'chat.runError.cliSessionRefusedMessage':
    "{agent} refused to start a session. The installed version is usually incompatible with Design Studio — switch to a different version and retry.",
  ...
  'chat.contextPrompt.referenceProject': 'Use the Design Studio project “{name}” as reference context. Its local path is: {path}. Before designing or modifying anything, search and read this directory when useful.',
  ...
  'app.brand': 'Design Studio',
  'app.brandPill': 'Research Preview',
  'app.brandSubtitle': 'by Nexu Labs',
  'app.welcomeLoading': 'Loading workspace…',
  'settings.welcomeKicker': '',
  'settings.welcomeTitle': 'Welcome to Design Studio',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. Design Studio will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. Design Studio reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingExecutionBody': 'Use the Design Studio hosted service, connect a local coding agent, or bring your own model key.',
  ...
  'settings.onboardingAmrModelSourceLabel': 'AERIS Hosted',
  ...
  'settings.onboardingCloudTitle': 'Sign in to AERIS Cloud',
  'settings.onboardingCloudBody': 'Sign in to start designing with AERIS in the cloud right away — no complex setup required.',
  'settings.onboardingCloudSignIn': 'Sign in to AERIS Cloud',
  ...
  'settings.onboardingGateTooltipNoRuntime': 'The next steps run on AERIS — pick a runtime to continue.',
  'settings.onboardingGateTooltipAmr': 'The next steps run on AERIS — sign in to AERIS Cloud to continue.',
  'settings.onboardingGateTooltipLocal': 'The next steps run on AERIS — select an available local CLI to continue.',
  'settings.onboardingGateTooltipByok': 'The next steps run on AERIS — add and test your model key to continue.',
  ...
  'settings.onboardingSourceAiTool': '🤖 Assistant tool (ChatGPT / Perplexity)',
  ...
  'settings.cloudCalloutTitle': 'Use AERIS Cloud',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the Design Studio daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to Design Studio.',
  ...
  'settings.amrWalletRefreshTitle': 'Refresh AERIS Cloud wallet balance',
  ...
  'settings.amrAccountStatus': 'AERIS Cloud account status',
  ...
  'settings.dshSetupDescription': 'Design Studio will install its connection component through the dsh CLI on this computer.',
  'settings.dshSetupNote': 'Only the Design Studio profile component is installed. DeepSeek Harness remains user-installed and user-managed.',
  ...
  'settings.mcpServerTitle': 'Design Studio MCP',
  'settings.mcpServerHint': 'Expose Design Studio as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the Design Studio team',
  'settings.privacyConsentKicker': 'Help us improve Design Studio',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how Design Studio performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time Design Studio starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but Design Studio could not quit automatically.',
  ...
  'settings.mcpTitle': 'Connect Design Studio to your coding agent',
  'settings.mcpHint': 'Use MCP to give supported agents access to your projects and design context.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure Design Studio is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Use the project and file currently open in Design Studio as context.',
  'settings.mcpRunningNote': 'Keep Design Studio running. Restart your coding agent after setup.',
  ...
  'entry.followXiaohongshuLabel': 'Follow us on Xiaohongshu',
  ...
  "entry.accountLanguageMeta": "English",
  ...
  "entry.cloudCalloutTitle": "AERIS Cloud",
  'entry.cloudRecovering': 'Account connection interrupted. Recovering automatically…',
  'entry.authExpiredBody': 'Your sign-in has expired. Sign in to continue using AERIS Cloud.',
  ...
  "entry.cloudCalloutBody": "Sign in to use AERIS Cloud and collaborate in the cloud",
  "entry.cloudCalloutDismissAria": "Dismiss AERIS Cloud note",
  ...
  'messageCenter.subtitle': 'Design Studio updates, platform announcements, and account notices.',
  ...
  'homeHero.title': 'What are we designing today?',
  ...
  'homeHero.subtitlePrefix': 'The chamber design desk — flyers, decks, social posts, and web pages, all in one place.',
  ...
  'homeHero.carousel.hint': 'Attach a file, link our brand kit, or describe what you want to make',
  'homeHero.carousel.onePageBrief': 'Draft a one-page event brief',
  'homeHero.carousel.notesToDeck': 'Turn my meeting notes into a presentation',
  'homeHero.carousel.signupFlow': 'Mock up an event signup flow',
  'homeHero.carousel.improveBrief': 'Tighten the headline on this announcement',
  'homeHero.carousel.loadingAnimation': 'Create a version sized for Instagram',
  'homeHero.carousel.teamUpdateSlides': 'Design slides for a board update',
  'homeHero.carousel.ordersDashboard': 'Prototype a dashboard for tracking memberships',
  'homeHero.carousel.productDetail': 'Lay out a member benefits page',
  'homeHero.carousel.caseStudy': 'Outline a member success story',
  'homeHero.carousel.landingIntro': 'Add a call to action to an event page',
  'homeHero.carousel.pitchDeck': 'Make a sponsorship pitch deck',
  'homeHero.carousel.appIdea': 'Turn this into a printable flyer',
  'homeHero.carousel.landingLayout': 'Sketch a landing page for the next mixer',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable Design Studio plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit AERIS Cloud',
  ...
  'handoff.promptIntro': 'Continue from this local Design Studio project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. Design Studio Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use Design Studio workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with Design Studio and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginsHome.commercialCategory.ai-literacy': 'Tech literacy',
  ...
  "pluginsView.marketplaceBody": "Install expert suites, skills, and connectors to add new work capabilities to Design Studio.",
  "pluginsView.marketplaceModeAria": "Marketplace mode",
  "pluginsView.marketplaceSourceFiltersAria": "Marketplace source filters",
  "pluginsView.scope.official": "Official",
  ...
  "pluginsView.importUrlBody": "Paste a public link for a {kind}. Design Studio will fetch the manifest, validate capabilities, and upload it to the team space.",
  ...
  "pluginsView.emptyPersonalHint": "Install from the official library, or use Add in the top right to create one.",
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use Design Studio from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure Design Studio is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use Design Studio everywhere',
  'useEverywhere.modalTitle': 'Use Design Studio everywhere',
  'useEverywhere.modalSubtitle': 'Drop Design Studio into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without Design Studio at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive Design Studio from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose Design Studio as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'Design Studio ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover Design Studio tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the Design Studio app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without Design Studio running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). Design Studio extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside Design Studio and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + Design Studio extras)',
  ...
  'connectors.category.aiAgents': 'Agents',
  'connectors.category.aiInfrastructure': 'Model infrastructure',
  ...
  'newproj.locationDefault': 'Design Studio projects',
  ...
  'socialShare.openDesignSection': 'Share the OpenDesign project',
  ...
  'socialShare.projectTitle': '{title} · Design Studio',
  'socialShare.projectText': 'Built with Design Studio: {title}. View the deployed artifact: {repo}',
  'socialShare.projectCopyText': 'Built with Design Studio: {title}\n{url}\nUpstream repo: {repo}',
  ...
  'project.brandReadyAiOptimize': 'AERIS Optimize',
  ...
  'brandEnrichment.title': "AERIS Optimize",
  'brandEnrichment.body': "Design Studio will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  'brandEnrichment.cta': "AERIS Optimize",
  'brandEnrichment.busy': "Starting AERIS Optimize...",
  ...
  'chat.activeFilePlaceholder': 'Ask Design Studio to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want Design Studio to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'designBrowser.reference.kicker': 'Design Studio browser',
  ...
  'designBrowser.reference.site.icons_lobehub.detail': 'Product and tech-brand icons for interfaces.',
  ...
  'designBrowser.reference.site.lummi.detail': 'Free generated visuals.',
  ...
  'chat.designToolbox.action.anti-ai-polish.title': 'Remove generated feel',
  'chat.designToolbox.action.anti-ai-polish.badge': 'Taste',
  'chat.designToolbox.action.anti-ai-polish.description': 'Remove template feel, generic gradients, cheap card stacks, and vague copy.',
  ...
  'chat.designToolbox.prompt.autoMatchIntro': 'Polish the layout and spacing so this is ready to put in front of members. Work it through like our design lead would:',
  'chat.designToolbox.prompt.autoMatchStep1': '1. Define what “good-looking design” means first: audience, business goal, brand feel, style references, information density, color/type/motion/asset standards, and generated/template patterns to avoid.',
  ...
  'chat.designToolbox.prompt.assetSearch': 'Find a photo for this design. Search the project files, connectors, MCP tools, browser captures, and image generation. Come back with real options, a note on how to use each one, any licensing or source caveats, and a generation prompt to fall back on if nothing usable turns up.',
  'chat.designToolbox.prompt.iconWorkflow': 'Make the colors and icons match our brand: fill in anything missing, replace whatever looks off, and keep stroke, fill, corner radius, and weight consistent across the piece. Use an icon library we already have where you can, and only draw a new SVG when nothing in the library fits.',
  ...
  'chat.designToolbox.prompt.motionPolish': 'Review the animation already on this piece and polish the timing, easing, performance, and accessibility. Cut anything abrupt, cheap, or hard to read, and rebuild the timeline where it needs a steadier hand.',
  ...
  'chat.designToolbox.prompt.antiAiPolish': 'Do one pass to take the machine-made look out of this: drop templated layouts, cheap gradients and glows, card stacks that carry no meaning, and vague filler copy. Keep every bit of the information and make it read like a real designer handed it over.',
  'chat.designToolbox.prompt.visualPolish': 'Tighten the headline and polish this until it is ready to send out: check hierarchy, typography, spacing, how it holds up at other sizes, button states, empty / loading / error states, and accessibility, then fix the most important problems directly.',
  ...
  'chat.designToolbox.prompt.chartGen': 'Build the right chart or diagram for this design. Pick the form that actually fits the numbers and what the reader needs to take away — a plain chart, a flow diagram, an SVG/CSS diagram, a relationship map, a dashboard, or a map view — then produce it.',
  ...
  'chat.example2Prompt': 'Design a landing page for a smart notes app that captures meetings, searches highlights, and turns notes into tasks. Include hero, product preview, feature story, social proof, pricing, FAQ, and CTA. Calm productivity aesthetic with a clear conversion path.',
  ...
  'preview.shareTextDefault': 'Design Studio template: {title}',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure Design Studio is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.documentTemplate.goalBody': 'Describe what Design Studio should generate, edit, or decide from this document.',
  ...
  'designFiles.documentTemplate.capabilityAgent': 'The Design Studio agent can read, edit, and use this file as project context.',
  ...
  'designFiles.documentTemplate.nextBody': 'Review and edit this document, then ask Design Studio to generate, revise, or operate from it.',
  ...
  'designFiles.usefulInfoTip7': 'Design Studio is built on the source-available OpenDesign project — star it on GitHub.',
  ...
  'fileViewer.versions.sourceAi': 'AERIS edit',
  ...
  'fileViewer.publishFileRequiresWorkspace': 'A share link needs a signed-in workspace. Sign in to AERIS Cloud, or use a deploy option to share this file.',
  ...
  'assistant.shareToOpenDesign': 'Share to the community',
  ...
  'nextStep.designSystemAiRefineTitle': 'AERIS refine design system',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Design Studio — pick one and adopt.',
  ...
  'pet.hatchTitle': 'Hatch a new pet with AERIS',
  ...
  'pet.codexBundledTitle': 'Ships with Design Studio — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple Design Studio project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.customInstructionsHint': 'Fixed instructions Design Studio should follow in every chat. Save facts, preferences, and project context as memories.',
  ...
  'settings.memoryEmptyHintZh': 'Remember: I prefer dark mode',
  ...
  'settings.memoryStarterProjectDesc': 'Design Studio v0.5 — chat-driven design editor',
  ...
  'updater.availableBody': 'Design Studio {version} is available. It will download before the installer can open.',
  'updater.activeRunsTitle': 'Design Studio is still working',
  'updater.activeRunsBody': '{count} active tasks are still running. Restarting now will interrupt them.',
  'updater.activeRunsUnknownBody': 'Design Studio could not confirm whether tasks are still running. Restarting now may interrupt active work.',
  ...
  'updater.installerOpenBody': 'The installer is open. Design Studio is quitting so you can finish the update.',
  ...
  'updater.payloadReadyGeneric': 'A new Design Studio update is ready. Design Studio will close and restart automatically.',
  'updater.payloadReadyVersion': 'Design Studio {version} is ready. Design Studio will close and restart automatically.',
  'updater.quitButton': 'Quit Design Studio',
  'updater.quitFailedBody': 'The installer is open, but Design Studio could not quit. Quit Design Studio before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. Design Studio will close and open the installer.',
  'updater.readyVersion': 'Design Studio {version} is ready. Design Studio will close and open the installer.',
  'updater.reinstallLearnMore': 'Learn more',
  'updater.reinstallReadyGeneric': 'This update requires a full reinstall. Design Studio will close and open the installer.',
  'updater.reinstallReadyVersion': 'Design Studio {version} requires a full reinstall. Design Studio will close and open the installer.',
  ...
  'whatsNew.updatedTitle': 'Design Studio {version} is here',
  ...
  'dsManager.createBody': 'Teach Design Studio your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions Design Studio follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach Design Studio your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'Design Studio turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
  ...
  'dsCreate.sourceSectionBody': 'Start with a GitHub repo, website, DESIGN.md, or files that show your style. Design Studio first creates a usable system quickly, then AERIS can refine it inside the project.',
  ...
  'dsCreate.describeBrandHelp': 'Brand voice, intro and product context. Used in the fast pass and AERIS refinement.',
  ...
  'ds.extractionRunningBody': 'Design Studio is updating this system in place.',
  ...
  'ds.repoConnectBannerBody': 'Connect GitHub so Design Studio can read your repository and pull colors, type, and components into this design system.',
  ...
  'library.getClipper': 'Get the Web Clipper',
  ...
  'library.emptyHintBefore': 'Clip from any page with the Web Clipper, run',
  ...
  'mcp.clickConnectHint': 'Click Connect to grant Design Studio access via the provider\'s OAuth flow.',
  ...
  'mcp.noManagedOAuthSaveDirect': 'Save this server and Design Studio will use it directly.',
  'mcp.noManagedOAuthUseAsConfigured': 'Design Studio will use this server as configured. Add headers below if the server needs a token.',
  ...
  'mcp.toGrantOAuthAccess': 'to grant Design Studio access via the provider\'s OAuth flow.',
  ...
  'memory.extractionSourceConnector': 'Connected apps were read, but Design Studio could not turn that context into memory.',
  'memory.extractionSourceChat': 'Design Studio could not run memory extraction for this chat.',
  ...
  'memory.noSuggestionsFound': 'No memory suggestions found. Design Studio could not read useful content from the selected app yet.',
  ...
  'memory.chooseSourcesHint': 'Select connected apps first. Design Studio only scans the apps you choose.',
  ...
  'dsCreate.confirmTitle': 'Design Studio will extract your design system.',
  ...
  'dsCreate.githubMethodOdAccount': 'AERIS Cloud account',
  'dsCreate.githubMethodOdAccountDesc': 'Native GitHub sign-in managed by Design Studio; this build does not use an OD-managed GitHub token yet.',
  ...
  'dsFlow.activityRunningTitle': 'Design Studio is updating this system',
  ...
  'dsFlow.composerPlaceholder': 'Follow-up action: use AERIS extraction to refine this system. Longer run; updates land here.',
  ...
  'dsFlow.jobRebuildingTokens': 'Design Studio is rebuilding tokens',
  'dsFlow.jobRevising': 'Design Studio is revising',
  'dsFlow.jobStillWorking': 'Design Studio is still working',
  ...
  'dsFlow.pickLocalAgentFirst': 'Pick a local agent first, then ask Design Studio to update this design system.',
  'dsFlow.previewPages': 'Preview pages',
  'dsFlow.proposedChanges': 'Proposed changes',
  'dsFlow.publishCardReady': 'Design Studio is ready for review. Give feedback on the work so far, then publish when it is useful for future projects.',
  'dsFlow.publishCardRevision': 'Design Studio is applying your feedback. You can keep reviewing while the updated draft is prepared.',
  'dsFlow.publishCardTokenRebuild': 'Design Studio is preparing a token contract rebuild for review. The active contract stays unchanged until you accept it.',
  'dsFlow.publishCardWorking': 'Design Studio is still working, but you can start giving feedback on the work so far.',
  ...
  'pluginDetail.officialBadge': 'Official plugin',
  ...
  'campaign.deepseekV4Flash.ruleSummary': 'From Aug 13–27, paid users can use DeepSeek V4 Pro and V4 Flash for free in Design Studio. Large-scale abuse may pause campaign access.',
  'campaign.deepseekV4Flash.windowLabel': 'Aug 13–27',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'two weeks free',
  'campaign.deepseekV4Flash.boundary': 'Unlimited model quota and free generation counts in your plan apply only inside Design Studio — not via MCP, CLI, API, or other surfaces. Some models may need to queue at peak hours.',
  ...
  'experienceSurvey.tag': "We'd love your feedback — help improve Design Studio",
  'experienceSurvey.close': "Close",
  'experienceSurvey.recommendation': "How likely are you to recommend Design Studio to a colleague or friend?",
  ...
  'labs.harnessHint': "Your next generation will use Design Studio's latest strategy, with noticeably more polished results (beta)",
  'labs.harnessTooltip': "Switches to the agent harness Design Studio uses for design work. Output is noticeably better in layout, structure, and completeness.",
