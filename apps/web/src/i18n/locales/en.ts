...
export const en: Dict = {
  ...
  'chat.historySearchPlaceholder': 'Search conversations',
  ...
  'designStructure.groupPageCount': '{groups} groups · {pages} pages',
  'designStructure.allPages': 'All pages',
  'designStructure.layersTitle': 'What {page} is made of',
  'designStructure.layerCount': '{n} layers',
  'designStructure.layersEmpty': 'This page has no structure to expand.',
  'designStructure.layersNoPage': 'Pick a page under Structure first.',
  'designStructure.editTitle': 'Pick an element on the canvas',
  'designStructure.editHint': 'Open the page, switch on Inspect in the viewer toolbar, then click an element to change its size, colours, text and interactions in place.',
  'designStructure.editOpen': 'Open {page}',
  'designStructure.assetsBrand': 'Brand',
  'designStructure.assetsMine': 'My assets',
  'designStructure.assetsBrandEmpty': 'This project has no design system files yet.',
  'designStructure.assetsMineEmpty': 'This project has no images yet.',
  ...
  'fileViewer.selectTool': 'Select',
  'fileViewer.flowChart': 'Flow',
  'fileViewer.flowChartPending': 'Flow view is not available for this file yet',
  'fileViewer.flowEmpty': 'This project has no pages to map yet.',
  'fileViewer.flowTitle': 'Flow · {name} · {screens} screens · {links} transitions',
  'fileViewer.flowFocusTitle': 'Flow · {name} · {screen} · 100%',
  'fileViewer.flowFocusHint': '{screen} · shown at 100% · Esc to exit',
  'fileViewer.flowOpenPage': 'Open this page',
  'fileViewer.flowGroupChip': '{name} · {screens} screens',
  'fileViewer.flowCurrentPage': 'Current page',
  'fileViewer.flowThumbUnavailable': 'Preview unavailable',
  'fileViewer.flowSummary': '{pages} pages · {links} links',
  'fileViewer.flowNoLinks': 'No page links between them yet',
  'fileViewer.flowOmitted': '{n} more pages are not shown',
