...
export const en: Dict = {
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AERIS — sign in to OpenDesign Cloud to continue.',
  ...
  'chat.designToolbox.prompt.antiAiPolish': 'Do one anti-generated-feel polish pass: remove templated layouts, cheap gradients/glows, meaningless card stacks, and vague copy. Preserve information and make it feel like a real designer delivered it.',
