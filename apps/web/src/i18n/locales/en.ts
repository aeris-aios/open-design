...
export const en: Dict = {
  ...
  'chat.runError.modelWindowLimitSwitchMessage': 'High demand right now — please try again after {retryAt}. This request was not charged. You can switch to another model to keep going.',
  'chat.runError.modelWindowLimitMessageNoTime': 'High demand right now — please try again shortly. This request was not charged.',
  'chat.runError.modelWindowLimitSwitchMessageNoTime': 'High demand right now — please try again shortly. This request was not charged. You can switch to another model to keep going.',
  ...
  'home.goUpsell.title': 'An AI design & coding plan everyone can use',
  'home.goUpsell.message': '$5 for the first month, then $10/month. The full Open Design design and coding capability with more cost-effective models — no API key setup, just open it and start designing.',
  'home.goUpsell.benefitsTitle': 'What Go gives you',
  'home.goUpsell.benefit1': 'Popular models with an ample allowance, no API key needed',
  'home.goUpsell.benefit2': 'Full design and coding capability — no locked features',
  'home.goUpsell.benefit3': '2 concurrent tasks, 259+ Skills workflows',
  'home.goUpsell.benefit4': 'Fixed monthly price, no surprise bills',
  'home.goUpsell.primaryCta': 'View Go plan',
  'home.goBadge.label': 'Go — $5 first month',
  'home.goBadge.labelPromo': 'Go — $5 first month · unlimited',
  'home.goBadge.aria': 'Go plan: $5 for the first month. Open the plan chooser',
