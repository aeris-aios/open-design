...
export const en: Dict = {
  ...
  'chat.runError.inactivityTimeoutMessage': "Waited {minutes} minutes with no new output, so this stopped for now — everything done so far is kept.",
  'chat.runError.inactivityTimeoutMessageNoTime': "No new output arrived for a long time, so this stopped for now — everything done so far is kept.",
