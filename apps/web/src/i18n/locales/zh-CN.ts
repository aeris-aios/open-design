...
export const zhCN: Dict = {
  ...
  "settings.odNextRolloutHint": "此 daemon 实例的 OD Next 自动路由安全状态。",
  "settings.odNextRolloutScope": "作用域",
  "settings.odNextRolloutRequested": "请求模式",
  "settings.odNextRolloutEffective": "生效模式",
  "settings.odNextRolloutLatch": "安全闩",
  "settings.odNextRolloutRefresh": "刷新",
  "settings.odNextRolloutReset": "重置安全闩",
  "settings.odNextRolloutResetConfirm": "确认重置",
  "settings.odNextRolloutResetting": "正在重置…",
  "settings.odNextRolloutLoadFailed": "无法读取 OD Next 灰度状态。",
  "settings.odNextRolloutResetFailed": "无法重置 OD Next 安全闩。请刷新后重试。",
  ...
  "homeHero.chip.marketingDesc": "营销活动与落地页",
  ...
  "homeHero.chip.marketingNext": "打开对话,创建带有清晰信息和转化路径的营销内容。",
