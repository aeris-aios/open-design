...
export const zhCN: Dict = {
  ...
  "chat.runError.title.agentCrashed": "智能体意外退出",
  ...
  "chat.queuedSteerUnsupported": "当前 agent 不支持中途插话",
  ...
  "chat.queuedChipFilesOne": "{n} 个文件",
  "chat.queuedChipFilesMany": "{n} 个文件",
  "chat.queuedChipMarksOne": "{n} 个标记",
  "chat.queuedChipMarksMany": "{n} 个标记",
  "chat.queuedChipPluginsOne": "{n} 个插件",
  "chat.queuedChipPluginsMany": "{n} 个插件",
  "chat.queuedChipSkillsOne": "{n} 个技能",
  "chat.queuedChipSkillsMany": "{n} 个技能",
  "chat.queuedChipMcpOne": "{n} 个 MCP 服务",
  "chat.queuedChipMcpMany": "{n} 个 MCP 服务",
  "chat.queuedChipConnectorsOne": "{n} 个连接器",
  "chat.queuedChipConnectorsMany": "{n} 个连接器",
  "chat.queuedChipContextOne": "{n} 个上下文项",
  "chat.queuedChipContextMany": "{n} 个上下文项",
  "chat.send": "发送",
  "chat.stop": "停止",
  ...
  "chat.amrBalanceOwner.message": "这个工作区的余额和套餐由所有者管理。把下面这句话发给他，充值到账后任务会自动继续。",
  "chat.amrBalanceOwner.requestTemplate": "我们工作区的 Open Design 余额用完了，任务跑不起来。麻烦你去 Open Design 控制台充值或升级套餐。",
  "chat.amrBalanceOwner.copyCta": "复制请求",
  "chat.amrBalanceOwner.copiedCta": "已复制",
