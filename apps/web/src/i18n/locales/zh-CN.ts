...
export const zhCN: Dict = {
  ...
  "homeHero.titleWords": "文档,幻灯片,图片,视频,UI Mockup,线框图",
  ...
  "homeWorkingDir.exclusiveHint": "先移除当前选择，再选其它内容",
  ...
  'campaign.deepseekV4Flash.workbenchBadge': 'DeepSeek V4 Pro / Flash 无限免费用',
