...
export const zhCN: Dict = {
  ...
  "chat.runError.modelWindowLimitSwitchMessage": "高峰期繁忙，请在 {retryAt} 后尝试（本次请求未扣费），可切换其他模型继续",
  "chat.runError.modelWindowLimitMessageNoTime": "高峰期繁忙，请稍后再试（本次请求未扣费）",
  "chat.runError.modelWindowLimitSwitchMessageNoTime": "高峰期繁忙，请稍后再试（本次请求未扣费），可切换其他模型继续",
  ...
  'common.dismiss': '关闭',
  'home.goUpsell.title': '人人可用的 AI 设计 Coding Plan',
  'home.goUpsell.message': '首月 $5，之后 $10/月。完整的 Open Design 设计与 Coding 能力，更具性价比的模型；无需 API Key，打开就能开始做设计。',
  'home.goUpsell.benefitsTitle': 'Go 能给你什么',
  'home.goUpsell.benefit1': '热门模型充裕额度，无需配置 API Key',
  'home.goUpsell.benefit2': '完整设计与 Coding 能力，不锁功能',
  'home.goUpsell.benefit3': '2 个任务并发，259+ Skills 工作流',
  'home.goUpsell.benefit4': '固定月费，不产生意外账单',
  'home.goUpsell.primaryCta': '查看 Go 套餐',
  'home.goBadge.label': 'Go 首月 $5',
  'home.goBadge.labelPromo': 'Go 首月 $5 · 无限用',
  'home.goBadge.aria': 'Go 套餐首月 $5，打开套餐选择页',
