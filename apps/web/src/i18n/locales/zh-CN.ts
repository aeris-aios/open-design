...
export const zhCN: Dict = {
  ...
  "chat.historySearchPlaceholder": "搜索对话",
  ...
  "designStructure.tabStructure": "结构",
  "designStructure.tabLayers": "图层",
  "designStructure.tabEdit": "编辑",
  "designStructure.tabAssets": "资产",
  "designStructure.groupPageCount": "{groups} 组 · {pages} 页",
  "designStructure.allPages": "全部页面",
  "designStructure.layersTitle": "{page} 的构成",
  "designStructure.layerCount": "{n} 层",
  "designStructure.layersEmpty": "这个页面没有可展开的结构。",
  "designStructure.layersNoPage": "先在结构里选一个页面。",
  "designStructure.editTitle": "在画布上点一个元素",
  "designStructure.editHint": "打开页面，在预览工具栏里开启检查，点中元素就能就地改它的尺寸、颜色、文字和交互。",
  "designStructure.editOpen": "打开 {page}",
  "designStructure.assetsBrand": "品牌中心",
  "designStructure.assetsMine": "我的素材",
  "designStructure.assetsBrandEmpty": "这个项目还没有设计体系文件。",
  "designStructure.assetsMineEmpty": "这个项目还没有图片素材。",
  ...
  "fileViewer.selectTool": "选择",
  "fileViewer.flowChart": "流程图",
  "fileViewer.flowChartPending": "这个文件还没有流程图视图",
  "fileViewer.flowEmpty": "这个项目还没有可以画成流程的页面。",
  "fileViewer.flowTitle": "流程图 · {name} · {screens} 屏 · {links} 条跳转",
  "fileViewer.flowFocusTitle": "流程图 · {name} · {screen} · 100%",
  "fileViewer.flowFocusHint": "{screen} · 100% 展示 · Esc 退出",
  "fileViewer.flowOpenPage": "打开这个页面",
  "fileViewer.flowGroupChip": "{name} · {screens} 屏",
  "fileViewer.flowCurrentPage": "当前页面",
  "fileViewer.flowThumbUnavailable": "预览不可用",
  "fileViewer.flowSummary": "{pages} 页 · {links} 条跳转",
  "fileViewer.flowNoLinks": "页面之间还没有互相跳转",
  "fileViewer.flowOmitted": "还有 {n} 页未显示",
  ...
  'manualEdit.textAlignJustify': "两端对齐",
  'manualEdit.textStyle': "文本样式",
  'manualEdit.basic': "基础",
  'manualEdit.stroke': "描边",
  'manualEdit.spacing': "边距",
  'manualEdit.effects': "效果",
  'manualEdit.custom': "自定义",
  'manualEdit.mixed': "混合",
  'manualEdit.horizontal': "水平",
  'manualEdit.vertical': "垂直",
  'manualEdit.shadow': "阴影",
  'manualEdit.shadowNone': "无",
