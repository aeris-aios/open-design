...
export const zhTW: Dict = {
  ...
  "settings.about": "關於",
  "settings.odNextRolloutTitle": "OD Next 灰度控制",
  "settings.odNextRolloutHint": "此 daemon 執行個體的 OD Next 自動路由安全狀態。",
  "settings.odNextRolloutScope": "作用域",
  "settings.odNextRolloutRequested": "請求模式",
  "settings.odNextRolloutEffective": "生效模式",
  "settings.odNextRolloutLatch": "安全閂",
  "settings.odNextRolloutRefresh": "重新整理",
  "settings.odNextRolloutReset": "重設安全閂",
  "settings.odNextRolloutResetConfirm": "確認重設",
  "settings.odNextRolloutResetting": "正在重設…",
  "settings.odNextRolloutLoadFailed": "無法讀取 OD Next 灰度狀態。",
  "settings.odNextRolloutResetFailed": "無法重設 OD Next 安全閂。請重新整理後再試。",
  ...
  "homeHero.chip.marketingDesc": "行銷活動與登陸頁",
  ...
  "homeHero.chip.marketingNext": "開啟對話,建立具有清晰訊息與轉換路徑的行銷內容。",
