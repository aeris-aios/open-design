...
export const zhTW: Dict = {
  ...
  "chat.runError.modelWindowLimitSwitchMessage": "高峰期繁忙，請在 {retryAt} 後嘗試（本次請求未扣費），可切換其他模型繼續",
  "chat.runError.modelWindowLimitMessageNoTime": "高峰期繁忙，請稍後再試（本次請求未扣費）",
  "chat.runError.modelWindowLimitSwitchMessageNoTime": "高峰期繁忙，請稍後再試（本次請求未扣費），可切換其他模型繼續",
  ...
  'common.dismiss': '關閉',
  'home.goUpsell.title': '人人可用的 AI 設計 Coding Plan',
  'home.goUpsell.message': '首月 $5，之後 $10/月。完整的 Open Design 設計與 Coding 能力，更具性價比的模型；無需 API Key，打開就能開始做設計。',
  'home.goUpsell.benefitsTitle': 'Go 能給你什麼',
  'home.goUpsell.benefit1': '熱門模型充裕額度，無需設定 API Key',
  'home.goUpsell.benefit2': '完整設計與 Coding 能力，不鎖功能',
  'home.goUpsell.benefit3': '2 個任務並行，259+ Skills 工作流',
  'home.goUpsell.benefit4': '固定月費，不會產生意外帳單',
  'home.goUpsell.primaryCta': '查看 Go 方案',
  'home.goBadge.label': 'Go 首月 $5',
  'home.goBadge.labelPromo': 'Go 首月 $5 · 無限用',
  'home.goBadge.aria': 'Go 方案首月 $5，開啟方案選擇頁',
