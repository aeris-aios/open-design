...
export const zhTW: Dict = {
  ...
  "chat.historySearchPlaceholder": "搜尋對話",
  ...
  "designStructure.tabStructure": "結構",
  "designStructure.tabLayers": "圖層",
  "designStructure.tabEdit": "編輯",
  "designStructure.tabAssets": "資產",
  "designStructure.groupPageCount": "{groups} 組 · {pages} 頁",
  "designStructure.allPages": "全部頁面",
  "designStructure.layersTitle": "{page} 的組成",
  "designStructure.layerCount": "{n} 層",
  "designStructure.layersEmpty": "這個頁面沒有可展開的結構。",
  "designStructure.layersNoPage": "先在結構裡選一個頁面。",
  "designStructure.editTitle": "在畫布上點一個元素",
  "designStructure.editHint": "打開頁面，在預覽工具列開啟檢查，點中元素就能就地改它的尺寸、顏色、文字和互動。",
  "designStructure.editOpen": "打開 {page}",
  "designStructure.assetsBrand": "品牌中心",
  "designStructure.assetsMine": "我的素材",
  "designStructure.assetsBrandEmpty": "這個專案還沒有設計系統檔案。",
  "designStructure.assetsMineEmpty": "這個專案還沒有圖片素材。",
  ...
  "fileViewer.selectTool": "選擇",
  "fileViewer.flowChart": "流程圖",
  "fileViewer.flowChartPending": "這個檔案還沒有流程圖檢視",
  "fileViewer.flowEmpty": "這個專案還沒有可以畫成流程的頁面。",
  "fileViewer.flowTitle": "流程圖 · {name} · {screens} 螢幕 · {links} 條跳轉",
  "fileViewer.flowFocusTitle": "流程圖 · {name} · {screen} · 100%",
  "fileViewer.flowFocusHint": "{screen} · 100% 展示 · Esc 退出",
  "fileViewer.flowOpenPage": "開啟這個頁面",
  "fileViewer.flowGroupChip": "{name} · {screens} 螢幕",
  "fileViewer.flowCurrentPage": "目前頁面",
  "fileViewer.flowThumbUnavailable": "預覽不可用",
  "fileViewer.flowSummary": "{pages} 頁 · {links} 條跳轉",
  "fileViewer.flowNoLinks": "頁面之間還沒有互相跳轉",
  "fileViewer.flowOmitted": "還有 {n} 頁未顯示",
  ...
  'manualEdit.textAlignJustify': "左右對齊",
  'manualEdit.textStyle': "文字樣式",
  'manualEdit.basic': "基礎",
  'manualEdit.stroke': "描邊",
  'manualEdit.spacing': "邊距",
  'manualEdit.effects': "效果",
  'manualEdit.custom': "自訂",
  'manualEdit.mixed': "混合",
  'manualEdit.horizontal': "水平",
  'manualEdit.vertical': "垂直",
  'manualEdit.shadow': "陰影",
  'manualEdit.shadowNone': "無",
  'manualEdit.shadowSoft': "柔和",
  'manualEdit.shadowMedium': "中等",
