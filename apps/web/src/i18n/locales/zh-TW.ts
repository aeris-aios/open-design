...
export const zhTW: Dict = {
  ...
  "chat.runError.title.agentCrashed": "智慧體意外結束",
  "chat.runError.agentCrashedMessage": "{agent} 意外結束了，它沒說為什麼。重試通常就能恢復；反覆出現的話，把日誌傳給我們。",
  "chat.runError.title.accountSuspended": "帳號暫時被停用",
  "chat.runError.accountSuspendedMessage": "偵測到異常的付款風險。如果你覺得是誤判，聯絡我們，我們來查。",
  "chat.runError.fallbackMessage": "這次沒能順利完成。原始錯誤收在下面的「查看詳情」裡；反覆出現的話，把日誌傳給我們。",
  "common.cancel": "取消",
  ...
  "chat.queuedSteerUnsupported": "目前的 agent 不支援中途插話",
  ...
  "chat.queuedChipFilesOne": "{n} 個檔案",
  "chat.queuedChipFilesMany": "{n} 個檔案",
  "chat.queuedChipMarksOne": "{n} 個標記",
  "chat.queuedChipMarksMany": "{n} 個標記",
  "chat.queuedChipPluginsOne": "{n} 個外掛",
  "chat.queuedChipPluginsMany": "{n} 個外掛",
  "chat.queuedChipSkillsOne": "{n} 個技能",
  "chat.queuedChipSkillsMany": "{n} 個技能",
  "chat.queuedChipMcpOne": "{n} 個 MCP 伺服器",
  "chat.queuedChipMcpMany": "{n} 個 MCP 伺服器",
  "chat.queuedChipConnectorsOne": "{n} 個連接器",
  "chat.queuedChipConnectorsMany": "{n} 個連接器",
  "chat.queuedChipContextOne": "{n} 個情境項目",
  "chat.queuedChipContextMany": "{n} 個情境項目",
  "chat.send": "傳送",
  "chat.stop": "停止",
  ...
  "chat.amrBalanceOwner.message": "這個工作區的餘額和方案由擁有者管理。把下面這句話傳給他，儲值到帳後任務會自動繼續。",
  "chat.amrBalanceOwner.requestTemplate": "我們工作區的 Open Design 餘額用完了，任務跑不起來。麻煩你到 Open Design 主控台儲值或升級方案。",
  "chat.amrBalanceOwner.copyCta": "複製請求",
  "chat.amrBalanceOwner.copiedCta": "已複製",
