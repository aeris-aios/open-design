...
export const fa: Dict = {
  ...
  'chat.historySearchPlaceholder': 'جستجوی گفتگوها',
  ...
  'designStructure.tabStructure': 'ساختار',
  'designStructure.tabLayers': 'لایه‌ها',
  'designStructure.tabEdit': 'ویرایش',
  'designStructure.tabAssets': 'دارایی‌ها',
  'designStructure.groupPageCount': '{groups} گروه · {pages} صفحه',
  'designStructure.allPages': 'همهٔ صفحه‌ها',
  'designStructure.layersTitle': '{page} از چه ساخته شده',
  'designStructure.layerCount': '{n} لایه',
  'designStructure.layersEmpty': 'این صفحه ساختاری برای باز کردن ندارد.',
  'designStructure.layersNoPage': 'اول یک صفحه را در بخش ساختار انتخاب کنید.',
  'designStructure.editTitle': 'یک عنصر روی بوم انتخاب کنید',
  'designStructure.editHint': 'صفحه را باز کنید، Inspect را از نوار ابزار نمایشگر روشن کنید و روی یک عنصر کلیک کنید تا اندازه، رنگ، متن و تعامل‌هایش را همان‌جا تغییر دهید.',
  'designStructure.editOpen': 'باز کردن {page}',
  'designStructure.assetsBrand': 'برند',
  'designStructure.assetsMine': 'دارایی‌های من',
  'designStructure.assetsBrandEmpty': 'این پروژه هنوز فایل سیستم طراحی ندارد.',
  'designStructure.assetsMineEmpty': 'این پروژه هنوز تصویری ندارد.',
  ...
  'fileViewer.selectTool': 'انتخاب',
  'fileViewer.flowChart': 'نمودار',
  'fileViewer.flowChartPending': 'نمای نمودار برای این فایل هنوز موجود نیست',
  'fileViewer.flowEmpty': 'این پروژه هنوز صفحه‌ای برای ترسیم ندارد.',
  'fileViewer.flowTitle': 'نمودار · {name} · {screens} صفحه · {links} گذار',
  'fileViewer.flowFocusTitle': 'نمودار · {name} · {screen} · ۱۰۰٪',
  'fileViewer.flowFocusHint': '{screen} · نمایش ۱۰۰٪ · Esc برای خروج',
  'fileViewer.flowOpenPage': 'باز کردن این صفحه',
  'fileViewer.flowGroupChip': '{name} · {screens} صفحه',
  'fileViewer.flowCurrentPage': 'صفحهٔ فعلی',
  'fileViewer.flowThumbUnavailable': 'پیش‌نمایش در دسترس نیست',
  'fileViewer.flowSummary': '{pages} صفحه · {links} پیوند',
  'fileViewer.flowNoLinks': 'هنوز پیوندی بین صفحه‌ها نیست',
  'fileViewer.flowOmitted': '{n} صفحهٔ دیگر نمایش داده نشده',
