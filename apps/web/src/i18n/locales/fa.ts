...
export const fa: Dict = {
  ...
  'chat.runError.inactivityTimeoutMessage': "{minutes} دقیقه خروجی تازه‌ای نیامد، بنابراین فعلاً متوقف شد — هر چه تا اینجا انجام شده باقی می‌ماند.",
  'chat.runError.inactivityTimeoutMessageNoTime': "مدت زیادی خروجی تازه‌ای نیامد، بنابراین فعلاً متوقف شد — هر چه تا اینجا انجام شده باقی می‌ماند.",
