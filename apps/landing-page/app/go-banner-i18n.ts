...
const EN: GoBannerCopy = {
  ...
  detail: '$5 first month · no API key setup · full design and coding capability',
...
const COPY: Partial<Record<LandingLocaleCode, GoBannerCopy>> = {
  ...
  zh: {
    ...
    detail: '首月 $5 · 无需配置 API Key · 完整设计与 Coding 能力',
  ...
  ja: {
    ...
    detail: '初月 $5 · API キー設定不要 · デザインと Coding のフル機能',
  ...
  ko: {
    ...
    detail: '첫 달 $5 · API 키 설정 불필요 · 디자인과 Coding 전체 기능',
  ...
  de: {
    ...
    detail: '$5 im ersten Monat · kein API-Key nötig · voller Design- und Coding-Umfang',
  ...
  fr: {
    ...
    detail: '5 $ le premier mois · sans clé API · toutes les capacités design et coding',
  ...
  ru: {
    ...
    detail: '$5 за первый месяц · без настройки API-ключа · полные возможности',
  ...
  es: {
    ...
    detail: '$5 el primer mes · sin configurar API key · todas las capacidades',
  ...
  'pt-br': {
    ...
    detail: '$5 no primeiro mês · sem configurar API key · todos os recursos',
  ...
  it: {
    ...
    detail: '$5 il primo mese · nessuna API key da configurare · tutte le funzionalità',
  ...
  tr: {
    ...
    detail: 'İlk ay $5 · API anahtarı gerekmez · tüm tasarım ve coding yetenekleri',
