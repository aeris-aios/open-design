...
const COPY: Partial<Record<LandingLocaleCode, GoBannerCopy>> = {
  ...
  de: {
    ...
    detail: '5 $ im ersten Monat · 8 beliebte Modelle · großzügiges Kontingent',
  ...
  fr: {
    ...
    detail: '5 $ le premier mois · 8 modèles populaires · quota généreux',
  ...
  ru: {
    ...
    detail: '$5 за первый месяц · 8 популярных моделей · большой лимит',
  ...
  es: {
    ...
    detail: '$5 el primer mes · 8 modelos populares · capacidad amplia',
  ...
  'pt-br': {
    ...
    detail: '$5 no primeiro mês · 8 modelos populares · franquia ampla',
  ...
  it: {
    ...
    detail: '$5 il primo mese · 8 modelli popolari · quota generosa',
  ...
  tr: {
    ...
    detail: 'İlk ay $5 · 8 popüler model · yüksek kullanım kotası',
