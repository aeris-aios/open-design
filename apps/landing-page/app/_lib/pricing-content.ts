...
const PERSONAL_EN: PersonalPricingCopy = {
  ...
  unlimited: 'Unlimited',
  ample: 'Ample allowance',
  moreAmple: 'Higher allowance',
  ...
  usageTitle: 'Popular model request estimates',
...
const PERSONAL_ES: PersonalPricingCopy = {
  ...
  usageTitle: 'Estimaciones de solicitudes de modelos populares',
...
const PERSONAL_PT_BR: PersonalPricingCopy = {
  ...
  usageTitle: 'Estimativas de solicitações de modelos populares',
...
const PERSONAL_RU: PersonalPricingCopy = {
  ...
  usageTitle: 'Оценка запросов к популярным моделям',
...
const PERSONAL_FR: PersonalPricingCopy = {
  ...
  usageTitle: 'Estimation des requêtes des modèles populaires',
...
const PERSONAL_DE: PersonalPricingCopy = {
  ...
  usageTitle: 'Geschätzte Anfragen für beliebte Modelle',
