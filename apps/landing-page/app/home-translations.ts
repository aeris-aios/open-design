...
const en: HomeExtra = {
  ...
  faqTitle: 'Open Design FAQ: vibe design workspace, one design system, open source',
  footProduct: 'Product',
...
const zh: HomeExtra = {
  ...
  faqTitle: 'Open Design 常见问题 —— vibe design workspace、一套设计系统、开源',
  footProduct: '产品',
  footCommunity: '社区',
  footLegal: '法律',
  footPartners: '伙伴',
...
const ja: HomeExtra = {
  ...
  faqTitle: 'Open Design FAQ：vibe design workspace、ひとつのデザインシステム、オープンソース',
  footProduct: '製品',
...
const ko: HomeExtra = {
  ...
  faqTitle: 'Open Design FAQ: vibe design workspace, 하나의 디자인 시스템, 오픈소스',
  footProduct: '제품',
  footCommunity: '커뮤니티',
  footLegal: '법적 고지',
  footPartners: '파트너',
...
const de: HomeExtra = {
  ...
  faqTitle: 'Open Design FAQ: Vibe Design Workspace, ein Designsystem, Open Source',
  footProduct: 'Produkt',
  footCommunity: 'Community',
...
const fr: HomeExtra = {
  ...
  faqTitle: 'FAQ Open Design : vibe design workspace, un seul design system, open source',
  footProduct: 'Produit',
...
const ru: HomeExtra = {
  ...
  faqTitle: 'Open Design FAQ: vibe design workspace, единая дизайн-система, open source',
  footProduct: 'Продукт',
...
const es: HomeExtra = {
  ...
  faqTitle: 'FAQ de Open Design: vibe design workspace, un solo sistema de diseño, open source',
...
const ptBr: HomeExtra = {
  ...
  faqTitle: 'FAQ do Open Design: vibe design workspace, um único design system, open source',
  footProduct: 'Produto',
...
const it: HomeExtra = {
  ...
  faqTitle: 'FAQ di Open Design: vibe design workspace, un solo design system, open source',
...
const tr: HomeExtra = {
  ...
  faqTitle: 'Open Design SSS: vibe design workspace, tek tasarım sistemi, açık kaynak',
  footProduct: 'Ürün',
