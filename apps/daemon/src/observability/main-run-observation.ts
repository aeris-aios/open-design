...
export function buildStructuredMainRunObservationV1(
  ...
  return normalizeAgentObservationV1({
    ...
    attributes: {
      ...
      ...(input.contextBudget
        ? {
            contextBudgetAction: input.contextBudget.action,
            contextBudgetSource: input.contextBudget.source,
            estimatedPromptTokens: input.contextBudget.estimatedPromptTokens,
            ...(input.contextBudget.contextWindowTokens !== undefined
              ? { contextWindowTokens: input.contextBudget.contextWindowTokens }
              : {}),
            ...(input.contextBudget.reservedOutputTokens !== undefined
              ? { reservedOutputTokens: input.contextBudget.reservedOutputTokens }
              : {}),
            ...(input.contextBudget.safetyMarginTokens !== undefined
              ? { safetyMarginTokens: input.contextBudget.safetyMarginTokens }
              : {}),
            ...(input.contextBudget.inputBudgetTokens !== undefined
              ? { inputBudgetTokens: input.contextBudget.inputBudgetTokens }
              : {}),
            ...(input.contextBudget.budgetRatio !== undefined
              ? { contextBudgetRatio: input.contextBudget.budgetRatio }
              : {}),
            ...(input.contextBudget.priorSessionInputTokens !== undefined
              ? { priorSessionInputTokens: input.contextBudget.priorSessionInputTokens }
              : {}),
            ...(input.contextBudget.projectedInputTokens !== undefined
              ? { projectedSessionInputTokens: input.contextBudget.projectedInputTokens }
              : {}),
            ...(input.contextBudget.rolloverThresholdTokens !== undefined
              ? { rolloverThresholdTokens: input.contextBudget.rolloverThresholdTokens }
              : {}),
            ...(input.contextBudget.compactedPromptTokens !== undefined
              ? { compactedPromptTokens: input.contextBudget.compactedPromptTokens }
              : {}),
            ...(input.contextBudget.omittedTranscriptMessageBlocks !== undefined
              ? {
                  omittedTranscriptMessageBlocks:
                    input.contextBudget.omittedTranscriptMessageBlocks,
                }
              : {}),
          }
        : {}),
