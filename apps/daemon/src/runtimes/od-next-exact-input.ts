...
export const OD_NEXT_EXACT_INPUT_MAP_V1 = [
  ...
  },
  {
    ...
    owner: 'Task 03 frozen Skill context plus Task 04 pending inputs',
    textTarget: 'context',
    note: 'Carries the task-owned frozen Skill identity/body/side-file roster and only path-free pending attachment/workspace facts.',
  },
  {
...
export const OD_NEXT_SEMANTIC_REQUEST_FACT_MAP_V1 = [
  ...
  },
  {
    ...
    textTarget: 'context',
    note: 'Frozen Skill identity/body/roster is serialized here; attachment/workspace facts remain Task 04 pending state.',
  },
  {
    id: 'user_selected_skills',
    classification: 'initial_bundle',
    producer: 'daemon_system_prompt',
    source: 'ChatRequest.skillId + skillIds -> captureFrozenSkillPackage() -> renderFrozenSkillBundleContext()',
    owner: 'Task 03 immutable user Skill package',
    textTarget: 'context',
    note: 'Canonical ids, frozen bodies and explicit side-file roster are task-owned; source absolute paths never enter text.',
  },
  {
