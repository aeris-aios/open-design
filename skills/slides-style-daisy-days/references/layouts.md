# Daisy Days Slides layout registry
...
Registered layout IDs: `cover`, `rationale`, `possibilities`, `timeline`, `data`, `habits`, `quote`, `ownership`, `process`, `outcome`
...
| `possibilities` | Possibilities | Use this layout only for content that matches its demonstrated information shape. | Preserve its hierarchy, alignment, and signature spacing before adding variants. |
...
| `habits` | Habits | Use this layout only for content that matches its demonstrated information shape. | Preserve its hierarchy, alignment, and signature spacing before adding variants. |
...
| `ownership` | Ownership | Use this layout only for content that matches its demonstrated information shape. | Preserve its hierarchy, alignment, and signature spacing before adding variants. |
