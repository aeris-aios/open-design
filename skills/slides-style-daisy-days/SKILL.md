---
name: slides-style-daisy-days
zh_name: "雏菊日幻灯片"
en_name: "Daisy Days Slides"
description: "Create or restyle slide decks in the Daisy Days visual system: warm paper, outlined daisies, pastel mint and pink signals, and friendly centered editorial typography. Use for onboarding, enablement, community programmes, workshops, and education; avoid high-stakes financial or crisis communication. Works across HTML, PPTX, Keynote, Google Slides, and other editable slide formats."
triggers:
  - "Daisy Days Slides"
  - "雏菊日幻灯片"
  - "slides-style-daisy-days"
  - "Daisy Days slide style"
  - "apply this slide style"
  - "用这个风格做幻灯片"
tags: ["slides", "presentation", "design-system", "daisy-days"]
od:
  mode: design-system
  category: slides
  surface: web
...
- The content fits: onboarding, enablement, community programmes, workshops, and education.
- Do not select it for high-stakes financial or crisis communication, unless the user explicitly asks for the contrast.
...
- Preserve the visual signature: warm paper, outlined daisies, pastel mint and pink signals, and friendly centered editorial typography.
