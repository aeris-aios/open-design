---
name: slides-style-sakura-chroma
zh_name: "樱花彩页幻灯片"
en_name: "Sakura Chroma Slides"
description: "Create or restyle slide decks in the Sakura Chroma visual system: cream stock, magenta banners, rainbow stripes, playful badges, and Japanese editorial-pop composition. Use for culture, personal stories, creative portfolios, youth brands, and events; avoid formal board reporting or serious risk communication. Works across HTML, PPTX, Keynote, Google Slides, and other editable slide formats."
triggers:
  - "Sakura Chroma Slides"
  - "樱花彩页幻灯片"
  - "slides-style-sakura-chroma"
  - "Sakura Chroma slide style"
  - "apply this slide style"
  - "用这个风格做幻灯片"
tags: ["slides", "presentation", "design-system", "sakura-chroma"]
od:
  mode: design-system
  category: slides
  surface: web
...
- The content fits: culture, personal stories, creative portfolios, youth brands, and events.
- Do not select it for formal board reporting or serious risk communication, unless the user explicitly asks for the contrast.
...
- Preserve the visual signature: cream stock, magenta banners, rainbow stripes, playful badges, and Japanese editorial-pop composition.
