---
name: slides-style-soft-editorial
zh_name: "柔光编辑幻灯片"
en_name: "Soft Editorial Slides"
description: "Create or restyle slide decks in the Soft Editorial visual system: warm cream paper, Cormorant serif, sage, blush, and lemon accents with generous literary spacing. Use for consulting, long-form brand stories, advisory work, and calm research; avoid urgent launches or visually aggressive pitches. Works across HTML, PPTX, Keynote, Google Slides, and other editable slide formats."
triggers:
  - "Soft Editorial Slides"
  - "柔光编辑幻灯片"
  - "slides-style-soft-editorial"
  - "Soft Editorial slide style"
  - "apply this slide style"
  - "用这个风格做幻灯片"
tags: ["slides", "presentation", "design-system", "soft-editorial"]
od:
  mode: design-system
  category: slides
  surface: web
...
- The content fits: consulting, long-form brand stories, advisory work, and calm research.
- Do not select it for urgent launches or visually aggressive pitches, unless the user explicitly asks for the contrast.
...
- Preserve the visual signature: warm cream paper, Cormorant serif, sage, blush, and lemon accents with generous literary spacing.
