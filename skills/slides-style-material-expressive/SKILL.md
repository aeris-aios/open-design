---
name: slides-style-material-expressive
zh_name: "Material 表现主义流行幻灯片"
en_name: "Material Expressive Pop Slides"
description: "Create or restyle slide decks in the Material Expressive Pop visual system: bright lavender, acid lime, coral, violet, sculptural organic shapes, and confident geometric sans typography. Use for product launches, community, education, consumer technology, and creative strategy; avoid legal, policy, or restrained executive reporting. Works across HTML, PPTX, Keynote, Google Slides, and other editable slide formats."
triggers:
  - "Material Expressive Pop Slides"
  - "Material 表现主义流行幻灯片"
  - "slides-style-material-expressive"
  - "Material Expressive Pop slide style"
  - "apply this slide style"
  - "用这个风格做幻灯片"
tags: ["slides", "presentation", "design-system", "material-expressive"]
od:
  mode: design-system
  category: slides
  surface: web
...
- The content fits: product launches, community, education, consumer technology, and creative strategy.
- Do not select it for legal, policy, or restrained executive reporting, unless the user explicitly asks for the contrast.
...
- Preserve the visual signature: bright lavender, acid lime, coral, violet, sculptural organic shapes, and confident geometric sans typography.
