---
name: slides-style-risograph-zine
zh_name: "孔版印刷 Zine 幻灯片"
en_name: "Risograph Zine Slides"
description: "Create or restyle slide decks in the Risograph Zine visual system: uncoated stock, ultramarine and fluorescent coral inks, yellow paper fields, misregistration, halftone grain, and intentionally cropped type. Use for culture, campaigns, creative technology, events, and independent publishing; avoid formal governance or conservative finance. Works across HTML, PPTX, Keynote, Google Slides, and other editable slide formats."
triggers:
  - "Risograph Zine Slides"
  - "孔版印刷 Zine 幻灯片"
  - "slides-style-risograph-zine"
  - "Risograph Zine slide style"
  - "apply this slide style"
  - "用这个风格做幻灯片"
tags: ["slides", "presentation", "design-system", "risograph-zine"]
od:
  mode: design-system
  category: slides
  surface: web
...
- The content fits: culture, campaigns, creative technology, events, and independent publishing.
- Do not select it for formal governance or conservative finance, unless the user explicitly asks for the contrast.
...
- Preserve the visual signature: uncoated stock, ultramarine and fluorescent coral inks, yellow paper fields, misregistration, halftone grain, and intentionally cropped type.
