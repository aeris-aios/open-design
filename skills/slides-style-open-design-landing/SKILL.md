---
name: slides-style-open-design-landing
zh_name: "OpenDesign 杂志叙事幻灯片"
en_name: "OpenDesign Editorial Slides"
description: "Create or restyle slide decks in the OpenDesign Editorial visual system: warm paper, tight sans headings, italic serif emphasis, coral signals, and premium magazine pacing. Use for brand stories, founder narratives, partner decks, press, and product vision; avoid dense technical manuals or spreadsheet-like reporting. Works across HTML, PPTX, Keynote, Google Slides, and other editable slide formats."
triggers:
  - "OpenDesign Editorial Slides"
  - "OpenDesign 杂志叙事幻灯片"
  - "slides-style-open-design-landing"
  - "OpenDesign Editorial slide style"
  - "apply this slide style"
  - "用这个风格做幻灯片"
tags: ["slides", "presentation", "design-system", "open-design-landing"]
od:
  mode: design-system
  category: slides
  surface: web
...
- The content fits: brand stories, founder narratives, partner decks, press, and product vision.
- Do not select it for dense technical manuals or spreadsheet-like reporting, unless the user explicitly asks for the contrast.
...
- Preserve the visual signature: warm paper, tight sans headings, italic serif emphasis, coral signals, and premium magazine pacing.
