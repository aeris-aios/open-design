# Swiss Red Axis Slides layout registry
...
|---|---|---|---|
| `cover` | Cover | Open with one memorable thesis and minimal supporting copy. | Vertically center the complete copy block left of the red axis; keep the title dominant. |
