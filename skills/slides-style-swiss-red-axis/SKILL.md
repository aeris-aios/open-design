---
name: slides-style-swiss-red-axis
zh_name: "瑞士红轴幻灯片"
en_name: "Swiss Red Axis Slides"
description: "Create or restyle slide decks in the Swiss Red Axis visual system: warm white, a single structural red axis, black typographic mass, disciplined white space, and editorial numbering. Use for manifestos, executive recommendations, brand positioning, and decisive strategy; avoid playful onboarding or image-heavy lifestyle decks. Works across HTML, PPTX, Keynote, Google Slides, and other editable slide formats."
triggers:
  - "Swiss Red Axis Slides"
  - "瑞士红轴幻灯片"
  - "slides-style-swiss-red-axis"
  - "Swiss Red Axis slide style"
  - "apply this slide style"
  - "用这个风格做幻灯片"
tags: ["slides", "presentation", "design-system", "swiss-red-axis"]
od:
  mode: design-system
  category: slides
  surface: web
...
- The content fits: manifestos, executive recommendations, brand positioning, and decisive strategy.
- Do not select it for playful onboarding or image-heavy lifestyle decks, unless the user explicitly asks for the contrast.
...
- Preserve the visual signature: warm white, a single structural red axis, black typographic mass, disciplined white space, and editorial numbering.
