---
name: slides-style-peoples-platform
zh_name: "人民平台幻灯片"
en_name: "People's Platform Slides"
description: "Create or restyle slide decks in the People's Platform visual system: high-energy programme green, dark-blue serif type, numbered ledger rows, and public-information poster structure. Use for campaigns, programmes, community plans, and public-interest narratives; avoid quiet luxury or monochrome executive briefs. Works across HTML, PPTX, Keynote, Google Slides, and other editable slide formats."
triggers:
  - "People's Platform Slides"
  - "人民平台幻灯片"
  - "slides-style-peoples-platform"
  - "People's Platform slide style"
  - "apply this slide style"
  - "用这个风格做幻灯片"
tags: ["slides", "presentation", "design-system", "peoples-platform"]
od:
  mode: design-system
  category: slides
  surface: web
...
- The content fits: campaigns, programmes, community plans, and public-interest narratives.
- Do not select it for quiet luxury or monochrome executive briefs, unless the user explicitly asks for the contrast.
...
- Preserve the visual signature: high-energy programme green, dark-blue serif type, numbered ledger rows, and public-information poster structure.
