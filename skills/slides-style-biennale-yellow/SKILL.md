---
name: slides-style-biennale-yellow
zh_name: "双年展黄幻灯片"
en_name: "Biennale Yellow Slides"
description: "Create or restyle slide decks in the Biennale Yellow visual system: solar yellow, parchment, indigo editorial type, poster-scale circles, and cultural-programme composition. Use for cultural, curatorial, design, brand, and festival presentations; avoid dense finance or conservative enterprise reporting. Works across HTML, PPTX, Keynote, Google Slides, and other editable slide formats."
triggers:
  - "Biennale Yellow Slides"
  - "双年展黄幻灯片"
  - "slides-style-biennale-yellow"
  - "Biennale Yellow slide style"
  - "apply this slide style"
  - "用这个风格做幻灯片"
tags: ["slides", "presentation", "design-system", "biennale-yellow"]
od:
  mode: design-system
  category: slides
  surface: web
...
- The content fits: cultural, curatorial, design, brand, and festival presentations.
- Do not select it for dense finance or conservative enterprise reporting, unless the user explicitly asks for the contrast.
...
- Preserve the visual signature: solar yellow, parchment, indigo editorial type, poster-scale circles, and cultural-programme composition.
