---
name: slides-style-editorial-tritone
zh_name: "三色编辑幻灯片"
en_name: "Editorial Tri-Tone Slides"
description: "Create or restyle slide decks in the Editorial Tri-Tone visual system: cream, mustard, burgundy, large chapter numerals, and split editorial columns. Use for research briefs, policy reviews, cultural strategy, and magazine narratives; avoid neon technology launches or playful onboarding. Works across HTML, PPTX, Keynote, Google Slides, and other editable slide formats."
triggers:
  - "Editorial Tri-Tone Slides"
  - "三色编辑幻灯片"
  - "slides-style-editorial-tritone"
  - "Editorial Tri-Tone slide style"
  - "apply this slide style"
  - "用这个风格做幻灯片"
tags: ["slides", "presentation", "design-system", "editorial-tritone"]
od:
  mode: design-system
  category: slides
  surface: web
...
- The content fits: research briefs, policy reviews, cultural strategy, and magazine narratives.
- Do not select it for neon technology launches or playful onboarding, unless the user explicitly asks for the contrast.
...
- Preserve the visual signature: cream, mustard, burgundy, large chapter numerals, and split editorial columns.
